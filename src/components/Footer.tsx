    ...
    <footer className="bg-[#003893] text-white">
      <div className="mx-auto grid max-w-7xl gap-12 px-5 py-14 sm:px-8 lg:grid-cols-[1.3fr_1fr_1fr_1.2fr] lg:px-10 lg:py-16">
        <div>
          <div className="flex items-center gap-3">
            ...
            <span className="font-display text-2xl font-semibold">
              Nepal<span className="text-[#ff7184]">360</span>
            </span>
          </div>
          ...
          <div className="mt-7 flex gap-2">
            <a className="social-link" href="mailto:contact@nepal360.org" aria-label="Email"><Mail size={16} /></a>
        ...
        <div>
          ...
          <p className="text-sm leading-7 text-white/65">
            ...
            <a href="mailto:contact@nepal360.org" className="text-white hover:text-[#ff7184]">contact@nepal360.org</a>
            <br /><br />
            Fellowship desk<br />
            <a href="mailto:fellowship@nepal360.org" className="text-white hover:text-[#ff7184]">fellowship@nepal360.org</a>
          </p>
        </div>
      </div>
      <div className="border-t border-white/10">
        <div className="mx-auto flex max-w-7xl flex-col gap-2 px-5 py-5 text-xs text-white/45 sm:px-8 md:flex-row md:items-center md:justify-between lg:px-10">
          <span>© 2026 Nepal360 Media Network. All rights reserved.</span>
